...
| Condition | Dest | Output |
|-----------|------|--------|
| Success | stdout | Multi-line shell completion script generated by `clap_complete` (or `clap_complete_nushell` for nushell); the exact format depends on the requested shell |
| Unknown shell (error) | stderr | clap-generated argument error listing the supported shells |
