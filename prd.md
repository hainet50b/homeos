...
- [ ] Change "deleted directory" to "removed directory" in `homeos package remove --purge` and `homeos plugin remove --purge` output messages.
...
- [ ] Add `Dependencies` column to `homeos package list` table output.
